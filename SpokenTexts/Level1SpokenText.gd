...
var roksanaTextScientist = ["Who are you?", "What's going on? Where is my family?", "What do you mean?", "Somebody, you mean you?", "How do we do that?", "ME!", "I don't know how to go back in time!", "What's that?", "?????", "Wait!!!!!!"]
